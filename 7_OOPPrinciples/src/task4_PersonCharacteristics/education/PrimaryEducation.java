...
public class PrimaryEducation extends Education {
    public PrimaryEducation(String graduated, String enrollmentDate, String graduationDate, String institutionName) {
    ...
    public static String getInfo() {
        ...
        if (Education.graduated.equals("true")) {
            result += String.format(" %s started primary degree in %s on %s and finished ", hisOrHer, institutionName, Education.getEnrollFormat());
            ...
            result += String.format(" %s started primary degree in  %s on %s and is supposed to graduate ", heOrShe, institutionName, Education.getEnrollFormat());
